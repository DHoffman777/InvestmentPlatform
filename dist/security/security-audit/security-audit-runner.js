...
exports.SecurityAuditRunner = void 0;
const SecurityAuditFramework_1 = require("./SecurityAuditFramework");
...
class SecurityAuditRunner {
    ...
    async run() {
        try {
            ...
            const framework = new SecurityAuditFramework_1.SecurityAuditFramework(config);
    ...
    async loadSecurityConfiguration() {
        ...
        if (this.options.compliance) {
            config.compliance = this.options.compliance;
        }
        if (this.options.env) {
        ...
        if (this.options.format) {
            config.reporting.formats = this.options.format;
        }
        return config;
    }
    async executeSelectedAudit(framework) {
    ...
    async executeVulnerabilityOnlyAudit(framework) {
    ...
    async executePenetrationTestingOnly(framework) {
    ...
    async executeCodeSecurityReviewOnly(framework) {
    ...
    async executeComplianceAuditOnly(framework) {
    ...
    async executeConfigurationAuditOnly(framework) {
    ...
    async executeContinuousSecurityScan(framework) {
    ...
    setupSecurityEventListeners(framework) {
    ...
    async sendSecurityAlert(findings) {
    ...
    createEmergencyRemediationPlan(findings) {
    ...
    generateCodeSecurityRecommendations(findings) {
        return [
            {
    ...
    generateComplianceSummary(complianceStatus) {
        return {
    ...
    generateConfigurationRecommendations(findings) {
        return [
            {
    ...
    generateContinuousScanSummary(results) {
        return {
    ...
    generateContinuousMonitoringRecommendations(results) {
        return [
            {
...
exports.SecurityAuditRunner = SecurityAuditRunner;
// Parse command line arguments
function parseSecurityArguments() {
