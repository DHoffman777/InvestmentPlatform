...
const CustodianIntegrationService_1 = require("../services/custodianIntegration/CustodianIntegrationService");
...
const custodianIntegrationService = new CustodianIntegrationService_1.CustodianIntegrationService(prisma, kafkaService);
// Validation schemas
const custodianConnectionSchema = {
    custodianType: {
        required: true,
        enum: Object.values(CustodianIntegration_1.CustodianType),
    ...
    connectionType: {
        required: true,
        enum: Object.values(CustodianIntegration_1.APIConnectionType),
...
const dataFeedRequestSchema = {
    feedType: {
        required: true,
        enum: Object.values(CustodianIntegration_1.DataFeedType),
 ...
 * @access Private
 */
router.post('/connections', auth_1.authMiddleware, (0, validation_1.validateRequest)(custodianConnectionSchema), async (req, res) => {
    try {
        ...
        const result = await custodianIntegrationService.createCustodianConnection(tenantId, connectionRequest, userId);
        res.status(201).json({
            success: true,
            data: {
 ...
 * @access Private
 */
router.get('/connections/:connectionId', auth_1.authMiddleware, async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error fetching custodian connection:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
...
router.get('/connections', auth_1.authMiddleware, async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error listing custodian connections:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
 ...
 * @access Private
 */
router.post('/connections/:connectionId/data-feed', auth_1.authMiddleware, (0, validation_1.validateRequest)(dataFeedRequestSchema), async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        if (!tenantId) {
        ...
        const result = await custodianIntegrationService.processCustodianDataFeed(connectionId, dataFeedRequest);
        res.json({
            success: true,
            data: result,
 ...
 * @access Private
 */
router.get('/connections/:connectionId/data-feeds', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        ...
        logger_1.logger.error('Error fetching data feed history:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
 ...
 * @access Private
 */
router.post('/connections/:connectionId/reconciliation', auth_1.authMiddleware, (0, validation_1.validateRequest)(reconciliationRequestSchema), async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        if (!tenantId) {
        ...
        const reconciliationRequest = {
            ...
            tolerance: new library_1.Decimal(req.body.tolerance || 0.01)
        };
        ...
        const result = await custodianIntegrationService.performReconciliation(connectionId, reconciliationRequest);
        res.json({
            success: true,
            data: result,
 ...
 * @access Private
 */
router.get('/connections/:connectionId/reconciliations', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        ...
        logger_1.logger.error('Error fetching reconciliation history:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
 ...
 * @access Private
 */
router.post('/connections/:connectionId/orders', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        if (!tenantId) {
        ...
        const result = await custodianIntegrationService.submitOrders(connectionId, orderSubmissionRequest);
        res.json({
            success: true,
            data: result,
 ...
 * @access Private
 */
router.post('/connections/:connectionId/documents', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        if (!tenantId) {
        ...
        const documentRetrievalRequest = {
            custodianConnectionId: connectionId,
            ...req.body
        };
        // Convert date strings to Date objects
        ...
        const result = await custodianIntegrationService.retrieveDocuments(connectionId, documentRetrievalRequest);
        res.json({
            success: true,
            data: result,
 ...
 * @access Private
 */
router.get('/connections/:connectionId/performance', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        ...
        logger_1.logger.error('Error fetching custodian performance metrics:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
 ...
 * @access Private
 */
router.get('/connections/:connectionId/alerts', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        ...
        logger_1.logger.error('Error fetching custodian alerts:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
 ...
 * @access Private
 */
router.post('/connections/:connectionId/test', auth_1.authMiddleware, async (req, res) => {
    try {
        const { connectionId } = req.params;
        const tenantId = req.user?.tenantId;
        if (!tenantId) {
        ...
        logger_1.logger.info('Testing custodian connection', { connectionId, tenantId });
        ...
        logger_1.logger.error('Error testing custodian connection:', error);
        res.status(500).json({
            error: error instanceof Error ? error.message : 'Internal server error',
