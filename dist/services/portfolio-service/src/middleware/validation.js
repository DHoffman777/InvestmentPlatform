...
function validateRequestBody(body, schema) {
    ...
    if (unexpectedFields.length > 0) {
        logger_1.logger.warn('Unexpected fields in request body:', unexpectedFields);
...
function validateRequest(schema) {
    return (req, res, next) => {
        try {
            ...
            logger_1.logger.error('Error in validation middleware:', error);
            res.status(500).json({
...
function validateQuery(schema) {
    return (req, res, next) => {
        try {
            ...
            logger_1.logger.error('Error in query validation middleware:', error);
            res.status(500).json({
                error: 'Internal server error',
...
function validateParams(schema) {
    return (req, res, next) => {
        try {
            ...
            logger_1.logger.error('Error in params validation middleware:', error);
            res.status(500).json({
                error: 'Internal server error',
