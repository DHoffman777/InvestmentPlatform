...
const DatabaseOptimizer_1 = require("./services/DatabaseOptimizer");
const QueryPerformanceAnalyzer_1 = require("./services/QueryPerformanceAnalyzer");
const DatabaseMonitor_1 = require("./services/DatabaseMonitor");
const ApiPerformanceOptimizer_1 = require("./services/ApiPerformanceOptimizer");
const CachingStrategy_1 = require("./services/CachingStrategy");
...
class PerformanceOptimizationService {
    ...
    initializeServices() {
        ...
        this.dbOptimizer = new DatabaseOptimizer_1.DatabaseOptimizer();
        this.queryAnalyzer = new QueryPerformanceAnalyzer_1.QueryPerformanceAnalyzer();
        this.dbMonitor = new DatabaseMonitor_1.DatabaseMonitor();
        this.apiOptimizer = new ApiPerformanceOptimizer_1.ApiPerformanceOptimizer();
    ...
    async considerAutoOptimization(recommendation) {
    ...
    setupRoutes() {
        ...
        this.app.get('/api/v1/api/endpoint-analysis/:endpoint', async (req, res) => {
            try {
                ...
                const analysis = this.apiOptimizer.analyzeEndpoint(endpoint, method, parseInt(timeWindow));
                res.json(analysis);
            }
            catch (error) {
        ...
        this.app.get('/api/v1/performance/comprehensive-report', async (req, res) => {
            try {
                const timeWindow = parseInt(req.query.timeWindow) || 86400000;
                const [dbReport, apiReport, cacheReport, healthStats] = await Promise.allSettled([
    ...
    async generateTrendAnalysis(timeWindow) {
