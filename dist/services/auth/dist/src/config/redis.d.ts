...
export const redisClient: import("@redis/client").RedisClientType<{
    graph: {
...
} & redis_1.RedisModules, redis_1.RedisFunctions, redis_1.RedisScripts>;
export class CacheService {
    ...
    expire(key: any, ttl: any): Promise<void>;
    setSession(sessionId: any, data: any, ttl?: number): Promise<void>;
    getSession(sessionId: any): Promise<any>;
    deleteSession(sessionId: any): Promise<void>;
    rateLimit(key: any, limit: any, window: any): Promise<{
        allowed: boolean;
        remaining: number;
    }>;
}
import redis_1 = require("redis");
