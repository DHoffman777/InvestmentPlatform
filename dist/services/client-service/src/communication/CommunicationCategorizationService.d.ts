...
export declare class CommunicationCategorizationService extends EventEmitter {
    ...
    updateRule(ruleId: string, updates: Partial<CategorizationRule>): Promise<void>;
    deleteRule(ruleId: string): Promise<void>;
    addKeywordSet(keywordSet: KeywordSet): Promise<void>;
    addPatternMatcher(pattern: PatternMatcher): Promise<void>;
    trainModel(trainingData: TrainingData[]): Promise<void>;
    recordFeedback(feedback: FeedbackData): Promise<void>;
