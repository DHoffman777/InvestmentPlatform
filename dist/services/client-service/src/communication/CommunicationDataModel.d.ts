...
export declare enum CommunicationDirection {
    INBOUND = "inbound",
    OUTBOUND = "outbound",
    INTERNAL = "internal",
...
export declare enum AttachmentAccessLevel {
    PUBLIC = "public",
    INTERNAL = "internal",
...
export declare enum VirusScanStatus {
    PENDING = "pending",
    CLEAN = "clean",
    INFECTED = "infected",
...
export declare enum PrivacyClassification {
    PUBLIC = "public",
    INTERNAL = "internal",
    CONFIDENTIAL = "confidential",
...
export declare enum AccessRestrictionType {
...
export declare enum ComplianceReviewStatus {
    PENDING = "pending",
    IN_REVIEW = "in_review",
    APPROVED = "approved",
    REJECTED = "rejected",
...
export declare enum CommunicationSortField {
    TIMESTAMP = "timestamp",
...
export declare enum PhoneFeature {
...
export declare enum VideoFeature {
    MEETINGS = "meetings",
    WEBINARS = "webinars",
    RECORDING = "recording",
