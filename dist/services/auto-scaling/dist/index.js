...
exports.financialProfile = exports.config = exports.AutoScalingService = void 0;
...
const config = {
    ...
    scaling: {
        ...
        provider: process.env.SCALING_PROVIDER || 'kubernetes',
        metrics: {
            sources: [
                {
                    name: 'cpu_usage',
...
const autoScalingService = new AutoScalingService_1.AutoScalingService(config, financialProfile);
// Event handlers
