...
class DistributedTracer {
  ...
  startTrace(operationName, options = {}) {
    ...
    return {
      ...
      createSpan: (spanOperationName, spanOptions = {}) => 
        this.createChildSpan(traceId, spanId, spanOperationName, spanOptions),
  ...
  getTracingStats() {
    ...
    return {
      ...
      operations: Object.fromEntries(
        Array.from(this.metrics.operations.entries()).map(([key, metrics]) => [
          key,
          {
            count: metrics.count,
