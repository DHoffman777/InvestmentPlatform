...
exports.seedCashInstruments = seedCashInstruments;
const client_1 = require("@prisma/client");
const cashService_1 = require("../services/cashService");
const logger_1 = require("../utils/logger");
const decimal_js_1 = require("decimal.js");
const prisma = new client_1.PrismaClient();
const cashService = new cashService_1.CashService(prisma);
...
const treasuryBills = [
    {
        ...
        parValue: new decimal_js_1.Decimal('100'),
        minimumBid: new decimal_js_1.Decimal('100'),
        bidIncrement: new decimal_js_1.Decimal('0.001'),
        auctionType: 'SINGLE_PRICE',
        totalIssued: new decimal_js_1.Decimal('45000000000'), // $45B
        discountRate: new decimal_js_1.Decimal('5.15'),
        yield: new decimal_js_1.Decimal('5.24'),
        daysToMaturity: 28,
    ...
    },
    {
        ...
        bidIncrement: new decimal_js_1.Decimal('0.001'),
        auctionType: 'SINGLE_PRICE',
        totalIssued: new decimal_js_1.Decimal('52000000000'), // $52B
        discountRate: new decimal_js_1.Decimal('5.12'),
        yield: new decimal_js_1.Decimal('5.26'),
        daysToMaturity: 91,
        dayCountConvention: 'ACTUAL_360',
    ...
    },
    {
        ...
        bidIncrement: new decimal_js_1.Decimal('0.001'),
        auctionType: 'SINGLE_PRICE',
        totalIssued: new decimal_js_1.Decimal('38000000000'), // $38B
        discountRate: new decimal_js_1.Decimal('5.08'),
        yield: new decimal_js_1.Decimal('5.32'),
        daysToMaturity: 182,
        dayCountConvention: 'ACTUAL_360',
    ...
    },
    {
        ...
        bidIncrement: new decimal_js_1.Decimal('0.001'),
        auctionType: 'SINGLE_PRICE',
        totalIssued: new decimal_js_1.Decimal('28000000000'), // $28B
        discountRate: new decimal_js_1.Decimal('4.95'),
        yield: new decimal_js_1.Decimal('5.15'),
        daysToMaturity: 365,
        dayCountConvention: 'ACTUAL_360',
...
const tips = [
    {
        ...
        bidIncrement: new decimal_js_1.Decimal('0.001'),
        auctionType: 'SINGLE_PRICE',
        totalIssued: new decimal_js_1.Decimal('16000000000'), // $16B
        couponRate: new decimal_js_1.Decimal('2.125'),
        yield: new decimal_js_1.Decimal('2.35'),
        realYield: new decimal_js_1.Decimal('2.12'),
        inflationIndexRatio: new decimal_js_1.Decimal('1.0234'),
        breakEvenInflationRate: new decimal_js_1.Decimal('2.45'),
        daysToMaturity: 1825, // 5 years
        duration: new decimal_js_1.Decimal('4.75'),
        convexity: new decimal_js_1.Decimal('0.23'),
...
const cashEquivalents = [
    {
        ...
        issueDate: new Date(),
        daysToMaturity: 30,
        minimumDenomination: new decimal_js_1.Decimal('100000'),
        parValue: new decimal_js_1.Decimal('1000000'),
        currentYield: new decimal_js_1.Decimal('5.35'),
        discountRate: new decimal_js_1.Decimal('5.28'),
        bankDiscountYield: new decimal_js_1.Decimal('5.30'),
        bondEquivalentYield: new decimal_js_1.Decimal('5.42'),
        effectiveAnnualRate: new decimal_js_1.Decimal('5.48'),
        issuer: 'Apple Inc',
    ...
    },
    {
        ...
        issueDate: new Date(),
        daysToMaturity: 90,
        minimumDenomination: new decimal_js_1.Decimal('1000'),
        parValue: new decimal_js_1.Decimal('10000'),
        currentYield: new decimal_js_1.Decimal('5.25'),
        effectiveAnnualRate: new decimal_js_1.Decimal('5.38'),
    ...
    },
    {
        ...
        daysToMaturity: 60,
        minimumDenomination: new decimal_js_1.Decimal('100000'),
        parValue: new decimal_js_1.Decimal('500000'),
        currentYield: new decimal_js_1.Decimal('5.18'),
        discountRate: new decimal_js_1.Decimal('5.12'),
        bankDiscountYield: new decimal_js_1.Decimal('5.15'),
        bondEquivalentYield: new decimal_js_1.Decimal('5.28'),
        issuer: 'Citibank N.A.',
        issuerType: 'BANK',
        creditRating: 'A',
        riskLevel: 'LOW',
    ...
    },
    {
        ...
        currency: 'USD',
        country: 'US',
        minimumDenomination: new decimal_js_1.Decimal('2500'),
        currentYield: new decimal_js_1.Decimal('4.35'),
        effectiveAnnualRate: new decimal_js_1.Decimal('4.45'),
        issuer: 'JPMorgan Chase Bank N.A.',
        issuerType: 'BANK',
        creditRating: 'A+',
        riskLevel: 'LOWEST',
    ...
    },
    {
        ...
        issueDate: new Date(),
        daysToMaturity: 1,
        minimumDenomination: new decimal_js_1.Decimal('1000000'),
        parValue: new decimal_js_1.Decimal('10000000'),
        currentYield: new decimal_js_1.Decimal('5.31'),
        effectiveAnnualRate: new decimal_js_1.Decimal('5.46'),
...
async function seedCashInstruments() {
    logger_1.logger.info('Starting cash instruments seeding process...');
    try {
        // Seed Treasury Bills
        logger_1.logger.info(`Seeding ${treasuryBills.length} Treasury Bills...`);
        for (const tbill of treasuryBills) {
            await cashService.upsertTreasury(tbill);
            logger_1.logger.info(`✓ Seeded Treasury Bill: ${tbill.symbol} - ${tbill.name}`);
        }
        // Seed TIPS
        logger_1.logger.info(`Seeding ${tips.length} TIPS...`);
        for (const tip of tips) {
            await cashService.upsertTreasury(tip);
            logger_1.logger.info(`✓ Seeded TIPS: ${tip.symbol} - ${tip.name}`);
        }
        // Seed Cash Equivalents
        logger_1.logger.info(`Seeding ${cashEquivalents.length} cash equivalents...`);
        for (const cashEq of cashEquivalents) {
            await cashService.upsertCashEquivalent(cashEq);
            logger_1.logger.info(`✓ Seeded cash equivalent: ${cashEq.symbol} - ${cashEq.name}`);
        }
        logger_1.logger.info('Cash instruments seeding completed successfully!');
        ...
        logger_1.logger.info('Cash instruments seeding summary:', {
            totalTreasuries,
        ...
        logger_1.logger.error('Error during cash instruments seeding:', {
...
if (require.main === module) {
    seedCashInstruments()
        .then(() => {
        logger_1.logger.info('Cash instruments seeding script completed');
        process.exit(0);
    })
        .catch((error) => {
        logger_1.logger.error('Cash instruments seeding script failed:', error);
        process.exit(1);
    })
        .finally(async () => {
...
//# sourceMappingURL=cashSeeder.js.map