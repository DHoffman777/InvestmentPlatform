...
const etfs = [
    {
        ...
        aum: new decimal_js_1.Decimal('380000000000'), // $380B
        ...
        averageDailyVolume: new decimal_js_1.Decimal('85000000'),
        navFrequency: 'DAILY',
    ...
    },
    {
        ...
        aum: new decimal_js_1.Decimal('85000000000'), // $85B
        ...
        averageDailyVolume: new decimal_js_1.Decimal('6500000'),
        navFrequency: 'DAILY',
        geographicFocus: 'DOMESTIC',
    ...
    },
    {
        ...
        aum: new decimal_js_1.Decimal('58000000000'), // $58B
        fundFamily: 'State Street Global Advisors',
        inceptionDate: new Date('2004-11-18'),
        averageDailyVolume: new decimal_js_1.Decimal('8500000'),
        navFrequency: 'DAILY',
...
const mutualFunds = [
    {
        ...
        aum: new decimal_js_1.Decimal('420000000000'), // $420B
    ...
    },
    {
        ...
        aum: new decimal_js_1.Decimal('350000000000'), // $350B
        ...
        minimumSubsequent: new decimal_js_1.Decimal('1'),
        navFrequency: 'DAILY',
        cutoffTime: '4:00 PM ET',
        settlementDays: 1,
        investmentStyle: 'BLEND',
    ...
    },
    {
        ...
        aum: new decimal_js_1.Decimal('120000000000'), // $120B
        ...
        minimumSubsequent: new decimal_js_1.Decimal('1000'),
        navFrequency: 'DAILY',
        cutoffTime: '4:00 PM ET',
        settlementDays: 1,
        geographicFocus: 'GLOBAL',
    ...
    },
    {
        ...
        aum: new decimal_js_1.Decimal('25000000000'), // $25B
    ...
    },
    {
        ...
        aum: new decimal_js_1.Decimal('8000000000'), // $8B
...
//# sourceMappingURL=fundsSeeder.js.map