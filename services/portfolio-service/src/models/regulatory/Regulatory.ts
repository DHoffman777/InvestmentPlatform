...
export interface FormADV {
  ...
  // Part 1A - Identifying Information
  part1A: {
    businessAddress: {
      street: string;
      city: string;
...
export interface FormPF {
  ...
  // Section 2 - Adviser and Fund Information
  section2: {
  ...
  // Section 3 - Fund Strategy and Risk
  section3: {
    investmentStrategy: {
  ...
  // Section 4 - Reporting Fund Information (Large Private Funds)
  section4?: {
    netAssetValue: number;
    grossAssetValue: number;
...
export interface GIPSComposite {
  ...
  // Composite Definition and Construction
  definition: {
  ...
  performanceData: Array<{
    ...
    compositeAssets: number; // In millions
    totalFirmAssets: number; // In millions
