...
import { UATAutomationFramework, TestConfig } from './UATAutomationFramework';
...
async function runUATSuite(): Promise<void> {
  const framework = new UATAutomationFramework(config);
