...
import { LoadTestingFramework, LoadTestConfig } from './LoadTestingFramework';
...
class LoadTestRunner {
  ...
  public async run(): Promise<void> {
    try {
      ...
      const framework = new LoadTestingFramework(config);
  ...
  private async loadConfiguration(): Promise<LoadTestConfig> {
  ...
  private async executeSelectedTest(framework: LoadTestingFramework): Promise<any> {
  ...
  private async executeEnduranceTest(framework: LoadTestingFramework): Promise<any> {
    ...
    const enduranceFramework = new LoadTestingFramework(enduranceConfig);
    return await enduranceFramework.executeLoadTest();
  }

  private async executeSpikeTest(framework: LoadTestingFramework): Promise<any> {
    ...
    for (const spike of spikeUsers) {
      ...
      const spikeFramework = new LoadTestingFramework(spikeConfig);
  ...
  private setupEventListeners(framework: LoadTestingFramework): void {
  ...
  private generateSpikeRecommendations(results: any[]): string[] {
