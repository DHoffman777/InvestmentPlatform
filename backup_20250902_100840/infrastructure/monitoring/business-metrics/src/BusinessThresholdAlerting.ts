...
export class BusinessThresholdAlerting extends EventEmitter {
  ...
  private evaluateValueCondition(value: number, condition: AlertCondition): Promise<boolean> {
  ...
  private evaluateTimeBasedCondition(metricValue: MetricValue, condition: AlertCondition): Promise<boolean> {
...
class AnomalyDetector {
  ...
  private zScoreDetection(value: number): Promise<boolean> {
  ...
  private iqrDetection(value: number): Promise<boolean> {
